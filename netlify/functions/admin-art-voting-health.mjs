...
const checks={admin_token:true,session_secret:!!process.env.HUGS_VOTER_SESSION_SECRET,resend_api_key:!!process.env.HUGS_VOTER_RESEND_API_KEY,verified_sender_configured:!!process.env.HUGS_VOTER_FROM_EMAIL,database_url:!!process.env.HUGS_VOTING_DATABASE_URL,database_tables:false,gallery_access:false};
