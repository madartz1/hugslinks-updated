...
(()=>{
 ...
 panel.querySelectorAll('.hh-option').forEach(b=>b.onclick=()=>{category=b.dataset.cat;title.textContent=category;options.style.display='none';form.style.display='block'});
